    ...
    <section>
      ...
      <div className="grid-4">
        {SUSTAINABILITY_METRICS.map((metric: SustainabilityMetric) => (
          <div key={metric.category} className="glass-card sustainability-center">
            ...
            <div className="util-style-6">
              {metric.current} / {metric.target} {metric.unit}
            </div>
            <span className={`stat-card-trend ${metric.trend} sustainability-trend`}>
      ...
      <div className="glass-card mt-24">
        ...
        <ul className="util-style-43">
          <li className="offline-list-item"><span className="icon-accent-emerald" aria-hidden="true">🌱</span> 100% renewable energy for venue operations</li>
          <li className="offline-list-item"><span aria-hidden="true">♻️</span> Zero single-use plastics in concession areas</li>
          <li className="offline-list-item"><span aria-hidden="true">💧</span> Rainwater harvesting for restroom facilities</li>
          <li className="offline-list-item"><span aria-hidden="true">🚌</span> Free shuttle buses to reduce car emissions</li>
        </ul>
      </div>
    </section>
  );
